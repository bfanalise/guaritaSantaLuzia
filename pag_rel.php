...
<body>
    <div id="global2">
        <header class="topo-lista">RELATÓRIOS SANTA LUZIA</header>
        <!--<nav class="menu"><a href="index.html">Cadastrar placa</a></nav>-->
        <div class="box-search">
            <input type="search" class="form-control w=25" placeholder="PESQUISAR PRODUTO/PLACA" id="pesquisar">
        ...
        <article class="tabela_artigo_2">
            <table>
                ...
                while($userdata = mysqli_fetch_assoc($result)){
                    ...
                    echo "<td class='bootstrap_3'><a class='bootst' href='edit.php?id=$userdata[id]'>" . $userdata['placa'] . "</a></td>";
