...
<body>
    <div id="global">
        <header>CONTROLE DE GUARITA - EDIÇÃO</header>
        <article>
            <form method="POST" action="update.php">
                <table class="tabela01">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="turno" placeholder="DIA/NOITE" value="<?php echo $turno?>"></td>
                ...
                <table class="tabela03">
                    ...
                    <tr>
                        ...
                        <td><input type="number" name="carga" placeholder="carga" value="<?php echo $carga?>"></td>
                    </tr>
                </table>
                <br>
                <hr>
                ...
                <table class="tabela03">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="observacao" placeholder="Observações"  value="<?php echo $observacao?>"></td></td>
                    </tr>
                </table>
                <br>
                <table>
                ...
                <td class="botao_rel-2">
                <a href="pag_rel.php" class="relatorio_secundario">RELATÓRIOS</a>
                </td>
                <td class="botao_rel-2">
                <a href="index.html" class="relatorio_secundario">CADASTRAR ENTRADA</a>
                </td>
                </table>
            </form>
        </article>
