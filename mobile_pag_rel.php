...
{
    $data = $_GET['search'];
    $sql = "SELECT * FROM cadastro WHERE produto LIKE '%$data%' or placa LIKE '%$data%' and dt_saida = '' ORDER BY id DESC";
}
else
{
    $sql = "SELECT * FROM cadastro WHERE dt_saida = '' ORDER BY id DESC";
}
...
<body>
    <div id="global2">
        ...
        <div class="box-search">
            <input type="search" class="form-control w=25" placeholder="PESQUISAR PLACA" id="pesquisar">
            ...
            <a href="mobile.html" class="botao_rel"><div class="botao_rel">
                NOVO
            </div></a>
    </div>
              ...
              <table class="relatorio">
                ...
                <tr class="cabecalho">
                    ...
                    <!--<th class="cbootstrap_6">PRODUTO</th>-->
                     ...
                     <!--<th class="cbootstrap_8">CARGA</th>-->
        ...
        <article class="tabela_artigo_2">
            <table>
                ...
                while($userdata = mysqli_fetch_assoc($result)){
                    ...
                    #echo "<td class='bootstrap_8'>" . $userdata['carga'] . "</td>";
                    ...
                    <a class='bootst' href='mobile_edit.php?id=$userdata[id]'>
                        <svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='#009970' class='bi bi-pencil-square' viewBox='0 0 17 17'>
                    ...
                    <svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='#3d3d3d' class='bi bi-trash3-fill' viewBox='0 0 17 17'>
